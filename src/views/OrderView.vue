  ...
  <div class="bg-gray-50">
    <div class="max-w-2xl mx-auto pt-16 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <div class="mt-6">
        ...
        <div class="space-y-8">
          <div v-for="product in products" :key="product.id" class="bg-white border-t border-b border-gray-200 shadow-sm sm:border sm:rounded-lg">
            ...
            <div class="border-t border-gray-200 py-6 px-4 sm:px-6 lg:p-8">
              ...
              <div class="mt-6" aria-hidden="true">
                <div class="bg-gray-200 rounded-full overflow-hidden">
                  <div class="h-2 bg-indigo-600 rounded-full" :style="{ width: `calc((${product.step} * 2 + 1) / 8 * 100%)` }" />
                </div>
