              ...
              <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                <div v-for="(paymentMethod, paymentMethodIdx) in paymentMethods" :key="paymentMethod.id"
                  ...
                  <input v-if="paymentMethodIdx === 0" :id="paymentMethod.id" name="payment-type" type="radio"
                         checked="" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300"/>
          ...
          <div class="mt-4 bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
              <button type="submit"
                ...
                <router-link :to="{name:'orders'}" class="w-full h-full">
                  Confirm order
                </router-link>
...
export default {
  name: 'Checkout-view',
  components: {
    RadioGroup, RadioGroupDescription, RadioGroupLabel, RadioGroupOption, CheckCircleIcon, TrashIcon
  },
  data() {
    return {
      products: [
