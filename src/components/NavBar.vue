...
<template>
  <header class="relative bg-white">
    <nav aria-label="Top" class=" mx-auto sm:px-6 lg:px-8">
          ...
          <div class="flex-1 flex items-center justify-end">
            ...
            <Popover class="ml-4 flow-root text-sm lg:relative lg:ml-8">
              ...
              <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0"
                ...
                <PopoverPanel
                    class="absolute top-16 inset-x-0 mt-px pb-6 bg-white shadow-lg sm:px-2 lg:top-full lg:left-auto lg:right-0 lg:mt-3 lg:-mr-1.5 lg:w-80 lg:rounded-lg lg:ring-1 lg:ring-black lg:ring-opacity-5 z-20">
...
export default {
  name: 'NavBar',
  components: {
    SearchIcon, ShoppingBagIcon, Popover, PopoverButton, PopoverPanel
  },
  data() {
    return {
